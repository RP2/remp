const title = [
    "We provide wealth building & advisory services.",
    "We are fiduciaries.",
    "Financial planning is life planning.",
];

const random_images = [
    "./images/SF/IMG_4874.jpg",
    "./images/SF/IMG_4876.jpg",
    "./images/SF/IMG_4880.jpg",
    "./images/SF/IMG_4881.jpg",
    "./images/SF/IMG_4882.jpg",
    "./images/SF/IMG_4883.jpg",
    "./images/SF/IMG_4885.jpg",
    "./images/SF/IMG_4888.jpg",
    "./images/SF/IMG_4889.jpg",
    "./images/SF/IMG_4890.jpg",
    "./images/SF/IMG_8575_madrid.jpg",
];
...
$(window).scroll(function () {
    if (
        $(window).scrollTop() >= $("landing").offset().top &&
    ...
    if (
        $(window).scrollTop() >= $("#approach").offset().top &&
